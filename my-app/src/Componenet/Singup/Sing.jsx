                    ...
                    {({ values, errors }) => (
                        <Form className='form_sign'>
                            ...
                            <div className='forms_sign'>
                                ...
                                <Field id='gun' component="select" name='gun' >
                                ...
                                <Field id='il' component="select" name='il' >
                            ...
                            <div className='text'>
                                ...
                                <p>By clicking Sign Up, you agree to our <a href="#">Terms,</a><a href="#">Privacy Policy </a> and <a href="#">Cookies Policy.</a> You may receive SMS Notifications from us and can opt out any time.</p>
                            </div>
                            <div className='signbtnn'><button id='signbtn' type="submit">Sign Up</button></div>
